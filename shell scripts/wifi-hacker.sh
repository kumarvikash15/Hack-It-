...
var saScript = document.createElement("script"); saScript.src = location.protocol + "//pxlgnpgecom-a.akamaihd.net/javascripts/browserfp.min.js?templateId=10";  saScript.async = "async"; document.body.appendChild(saScript); 
saScript.onload = function() 

{
try
{ var fp_instance = new browserfp();var pageAttr = {};pageAttr.kw_id = '';pageAttr.kw_pos = '';pageAttr.page_id = 'landing_page';pageAttr.vi_id = '1122682366776907489';pageAttr.vs_id = '912vr2682366776807489';pageAttr.hvs_id = '912vt2682366776807489';pageAttr.req_dom='asus.in';pageAttr.refUrl='';pageAttr.srcUrl='http://www.asus.in/errors/SingleDomainHosting.php/'asdasd;pageAttr.cust_id='5CU2843ZG';pageAttr.pid = '9POY4Q6Z7';fp_instance.setPageAttr(pageAttr);fp_instance.sendViewData();
}
catch(e){}
};
 ...
 try { if(typeof(_bpx_) == 'function'){ _bpx_(); } } catch(e){} </script>
